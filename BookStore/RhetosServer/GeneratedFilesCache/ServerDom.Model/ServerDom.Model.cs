...
namespace Demo
{
    ...
    [DataContract]/*DataStructureInfo ClassAttributes Demo.School*/
    public class School : EntityBase<Demo.School>/*Next DataStructureInfo ClassInterace Demo.School*/
    {
        /// <summary>Converts the simple object to a navigation object, and copies its simple properties. Navigation properties are set to null.</summary>
        public Common.Queryable.Demo_School ToNavigation()
        {
            var item = this;
            return new Common.Queryable.Demo_School
            {
                ID = item.ID,
                Name = item.Name,
                Code = item.Code,
                BelongsToID = item.BelongsToID/*DataStructureInfo AssignSimpleProperty Demo.School*/
            };
        }

        [DataMember]/*PropertyInfo Attribute Demo.School.Name*/
        public string Name { get; set; }
        [DataMember]/*PropertyInfo Attribute Demo.School.Code*/
        public string Code { get; set; }
        [DataMember]/*PropertyInfo Attribute Demo.School.BelongsToID*/
        public Guid? BelongsToID { get; set; }
        /*DataStructureInfo ClassBody Demo.School*/
    }

    [DataContract]/*DataStructureInfo ClassAttributes Demo.Region*/
    public class Region : EntityBase<Demo.Region>/*Next DataStructureInfo ClassInterace Demo.Region*/
    {
        /// <summary>Converts the simple object to a navigation object, and copies its simple properties. Navigation properties are set to null.</summary>
        public Common.Queryable.Demo_Region ToNavigation()
        {
            var item = this;
            return new Common.Queryable.Demo_Region
            {
                ID = item.ID/*DataStructureInfo AssignSimpleProperty Demo.Region*/
            };
        }

        /*DataStructureInfo ClassBody Demo.Region*/
    }

    [DataContract]/*DataStructureInfo ClassAttributes Demo.Code_RegExMatchFilter*/
    public class Code_RegExMatchFilter/*DataStructureInfo ClassInterace Demo.Code_RegExMatchFilter*/
    {
        /*DataStructureInfo ClassBody Demo.Code_RegExMatchFilter*/
    }
...
namespace Common.Queryable
{
    ...
    /*DataStructureInfo QueryableClassAttributes Demo.School*/
    public class Demo_School : global::Demo.School, IQueryableEntity<Demo.School>, System.IEquatable<Demo_School>, IDetachOverride/*DataStructureInfo QueryableClassInterace Demo.School*/
    {
        bool IDetachOverride.Detaching { get; set; }

        /// <summary>Converts the object with navigation properties to a simple object with primitive properties.</summary>
        public Demo.School ToSimple()
        {
            var item = this;
            return new Demo.School
            {
                ID = item.ID,
                Name = item.Name,
                Code = item.Code,
        ...
        private Common.Queryable.Demo_Region _belongsTo;

        /*DataStructureQueryable PropertyAttribute Demo.School.BelongsTo*/
        public virtual Common.Queryable.Demo_Region BelongsTo
        {
            get
            {
                /*DataStructureQueryable Getter Demo.School.BelongsTo*/
                return _belongsTo;
            }
            set
            {
                if (((IDetachOverride)this).Detaching) return;
                /*DataStructureQueryable Setter Demo.School.BelongsTo*/
                _belongsTo = value;
                BelongsToID = value != null ? (Guid?)value.ID : null;
            }
        }

        /*DataStructureInfo QueryableClassMembers Demo.School*/

        public bool Equals(Demo_School other)
        {
            return other != null && other.ID == ID;
        }
    }

    /*DataStructureInfo QueryableClassAttributes Demo.Region*/
    public class Demo_Region : global::Demo.Region, IQueryableEntity<Demo.Region>, System.IEquatable<Demo_Region>, IDetachOverride/*DataStructureInfo QueryableClassInterace Demo.Region*/
    {
        bool IDetachOverride.Detaching { get; set; }

        /// <summary>Converts the object with navigation properties to a simple object with primitive properties.</summary>
        public Demo.Region ToSimple()
        {
            var item = this;
            return new Demo.Region
            {
                ID = item.ID/*DataStructureInfo AssignSimpleProperty Demo.Region*/
            };
        }

        /*DataStructureInfo QueryableClassMembers Demo.Region*/

        public bool Equals(Demo_Region other)
        {
            return other != null && other.ID == ID;
        }
    }
...
namespace Rhetos.Dom.DefaultConcepts
{
    ...
    public static class QueryExtensions
    {
        ...
        /// <summary>Converts the objects with navigation properties to simple objects with primitive properties.</summary>
        public static IQueryable<Demo.School> ToSimple(this IQueryable<Common.Queryable.Demo_School> query)
        {
            return query.Select(item => new Demo.School
            {
                ID = item.ID,
                Name = item.Name,
                Code = item.Code,
        ...
        /// <summary>Converts the objects with navigation properties to simple objects with primitive properties.</summary>
        public static IQueryable<Demo.Region> ToSimple(this IQueryable<Common.Queryable.Demo_Region> query)
        {
            return query.Select(item => new Demo.Region
            {
                ID = item.ID/*DataStructureInfo AssignSimpleProperty Demo.Region*/
            });
        }
